...
/***/ "./src/exercicio-webpack/form-control.ts":
/*!***********************************************!*\
  !*** ./src/exercicio-webpack/form-control.ts ***!
  \***********************************************/
...
function checkEmptyFields(...inputs) {
    inputs.forEach(input => {
        if (!input.value)
            showErrorMessages(input, 'Este campo precisa ser preenchido');
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/exercicio-webpack/form-control.ts");
